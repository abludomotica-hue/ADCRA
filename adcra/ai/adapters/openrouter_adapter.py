...
class OpenRouterProvider(AIProviderAdapter):
        ...
        self._models = [
            {
                ...
                "capabilities": {
                    ...
                    ModelCapability.VISION.value: False,
            ...
            },
            {
                ...
                "capabilities": {
                    ModelCapability.REASONING.value: True,
                    ModelCapability.VISION.value: False,
                    ModelCapability.TOOL_CALLING.value: False,
                    ModelCapability.STRUCTURED_OUTPUT.value: True,
                    ModelCapability.STREAMING.value: True,
                    ModelCapability.WEB_SEARCH.value: False
                }
    ...
    @property
    def name(self) -> str:
        return "OpenRouter Model Aggregator"
    ...
    def generate(self, request: AIRequest) -> AIResponse:
        if not self._api_key:
            raise PermissionError("OpenRouter API key is missing or not configured")
        ...
        req = urllib.request.Request(
            ...
            headers={
                ...
                "HTTP-Referer": "https://adcra.creative.os",
        ...
        try:
            ...
            raise RuntimeError(f"OpenRouter HTTP Error {he.code}: {err_body}")
